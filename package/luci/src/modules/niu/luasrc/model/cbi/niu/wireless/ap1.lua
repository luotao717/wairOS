...
state:foreach("wireless", "wifi_iface",
	function(s)
...
--- Device Settings ---
s = m:section(NamedSection, device, "wifi_device", "Device Configuration")
s.addremove = false
...
s = m:section(NamedSection, iface, "wifi_iface", translate("Interface Details"))
s.addremove = false
