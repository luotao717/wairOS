...
uci:foreach("wireless", "wifi_device", function(section)
...
function main.write(self, section, value)
	...
	uci:foreach("wireless", "wifi_device",
	function(sec)
		...
		if client then
			...
			if dhcp_ip and dhcp_mask then
				...
				if vap then
					...
					uci:section("wireless", "wifi_iface", nil, {
						device     =device,
						mode       ="ap",
						encryption ="none",
						network    =nif .. "dhcp",
		...
		uci:section("wireless", "wifi_iface", nil, ifconfig)
		uci:save("network")
		uci:save("wireless")
		uci:save("network")
		uci:save("firewall")
