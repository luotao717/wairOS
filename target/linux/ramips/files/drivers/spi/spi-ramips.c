/*
 * ramips_spi.c -- Ralink MT7620 SPI controller driver
 *
...
#define DRIVER_DESC			"Ralink MT7620 SPI Controller driver"
...
{
	printk(KERN_INFO DRIVER_DESC " version " DRIVER_VERSION " Exit!\n");
