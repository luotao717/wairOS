...
static void ar934x_ip2_irq_init(void)
{
	...
	for (i = ATH79_IP2_IRQ_BASE;
		...
		set_irq_chip_and_handler(i, &dummy_irq_chip,
					 handle_level_irq);

	set_irq_chained_handler(ATH79_CPU_IRQ_IP2, ar934x_ip2_irq_dispatch);
}
...
static void qca955x_irq_init(void)
{
	...
	set_irq_chained_handler(ATH79_CPU_IRQ_IP2, qca955x_ip2_irq_dispatch);
	...
	set_irq_chained_handler(ATH79_CPU_IRQ_IP3, qca955x_ip3_irq_dispatch);
}
